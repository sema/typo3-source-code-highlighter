...
if (TYPO3_MODE=="BE")	$TBE_MODULES_EXT["xMOD_db_new_content_el"]["addElClasses"]["tx_semasourcecode_pi1_wizicon"] = t3lib_extMgm::extPath($_EXTKEY)."pi1/class.tx_semasourcecode_pi1_wizicon.php";
?>